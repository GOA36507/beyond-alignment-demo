...
class KnowledgeGraph():
    ...
    def build_inter_graph_structure(self, train_datasets=None):
        ...
        if hasattr(self.args, 'logger'):
            ...
            self.args.logger.info(
                f'[DEBUG] Inter-graph triples (only known alignments): '
